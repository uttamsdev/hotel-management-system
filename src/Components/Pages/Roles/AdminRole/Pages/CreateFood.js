...
const CreateFood = () => {
  ...
  const handleAddProduct = async (event) => {
    ...
    const foodId = event.target.foodId.value;
  ...
  return (
    <div className='bg-[#F1F5F9] bg-gradient-to-r from-stone-100 to-blue-50 calc-height'>
            <p className=' border pl-12 text-xl text-black mb-8 font-bold bg-[#F8FAFC] h-14 flex items-center'><MdFoodBank className='ml-5 mr-3 w-6 h-6'/>Add New Food</p>
      ...
      <div className="flex justify-center">
        ...
        >
          <label htmlFor="productName">Food Id:</label> <br />
          <input
            type="number"
            name="foodId"
