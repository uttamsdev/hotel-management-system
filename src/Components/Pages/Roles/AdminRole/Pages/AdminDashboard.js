...
const AdminDashboard = () => {
  ...
  return (
    <div className="bg-[#F1F5F9] bg-gradient-to-r from-stone-100 to-blue-50 calc-height">
      <div>
      <p className=' border pl-2 text-xl text-black mb-8 font-bold bg-[#F8FAFC] h-14 flex items-center'><AiOutlineDashboard className='ml-5 mr-3 w-6 h-6'/>Administrator Dashboard</p>
